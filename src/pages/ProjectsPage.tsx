...
import { ProjectFilters, type CategoryFilter } from '../components/projects/ProjectFilters';
...
export function ProjectsPage() {
  ...
  const activeFilterCount = technologies.length + (category === 'All' ? 0 : 1);
      ...
      <section className="border-b border-border">
        <div className="page-shell grid gap-8 py-6 sm:pb-3 sm:pt-7 lg:grid-cols-[1fr_190px] lg:items-center">
          ...
          <blockquote className="hidden border-l border-border-strong pl-7 text-sm leading-6 text-text-muted lg:block">
            “Better software for a more capable tomorrow.”
            <span className="mt-3 block h-px w-5 bg-text-subtle" aria-hidden="true" />
          </blockquote>
        </div>
      </section>

      <section className="page-shell py-5" aria-labelledby="projects-heading">
        <div>
          <SectionHeader
            id="projects-heading"
            title="Projects"
